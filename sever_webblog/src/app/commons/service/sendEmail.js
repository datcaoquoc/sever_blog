...
export const sendMailService = (dataUser) => {
    const mailOption = {
        from: ' "Blogchiasekienthuc.com" <quocdatcao5@gmail.com>',
        to: dataUser.email,
        subject: 'Email xác nhận đăng ký',
        html: `<h1>Xin chào ${dataUser.name}!</h1>
    <h3>Bạn vừa đăng kí tài khoản tại Blogchiasekienthuc.com</h3>
    <p>Đây là mã xác thực của bạn :</p>
    <h1 style="color: #D61109">${dataUser.validateCode}</h1>
